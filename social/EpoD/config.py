...
parser.add_argument('--cross_heads', type=int, default=500, help='number of epochs to train.')
parser.add_argument('--dim_feed', type=int, default=500, help='number of epochs to train.')
...
parser.add_argument('--min_epoch', type=int, default=150, help='min epoch')
...
if args.use_cfg:
    if args.dataset == 'collab':
        ...
        hp = {
            ...
            "norm": 1,
            "skip": 0,
            "dropout": 0.4, "use_RTE": 1, "n_intervene": 1000, "la_intervene": 0.01, "fmask": 1, "lin_bias": 0
        }
        setargs(args,hp)
